...
function changeImage()
{
  ...
  switch(val)
  {
    ...
    case 1: bg.style.background="url('Image/food.png') no-repeat center center/cover";
    break;
    case 2: bg.style.background="url('Image/food2.png') no-repeat center center/cover";
    break;
    case 3: bg.style.background="url('Image/food3.png') no-repeat center center/cover";
    break;
